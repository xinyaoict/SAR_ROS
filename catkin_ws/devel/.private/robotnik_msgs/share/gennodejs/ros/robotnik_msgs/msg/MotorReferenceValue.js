...
class MotorReferenceValue {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.float32(obj.spin, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.spin = _deserializer.float32(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return 'bee092bed901770c06bbd09306ce8598';
  }
