...
(cl:in-package interbotix_xs_sdk-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <MotorGains-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorGains-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name interbotix_xs_sdk-srv:<MotorGains-request> is deprecated: use interbotix_xs_sdk-srv:MotorGains-request instead.")))

(cl:ensure-generic-function 'cmd_type-val :lambda-list '(m))
(cl:defmethod cmd_type-val ((m <MotorGains-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xs_sdk-srv:cmd_type-val is deprecated.  Use interbotix_xs_sdk-srv:cmd_type instead.")
  (cmd_type m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <MotorGains-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xs_sdk-srv:name-val is deprecated.  Use interbotix_xs_sdk-srv:name instead.")
  (name m))

(cl:ensure-generic-function 'kp_pos-val :lambda-list '(m))
(cl:defmethod kp_pos-val ((m <MotorGains-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xs_sdk-srv:kp_pos-val is deprecated.  Use interbotix_xs_sdk-srv:kp_pos instead.")
  (kp_pos m))

(cl:ensure-generic-function 'ki_pos-val :lambda-list '(m))
(cl:defmethod ki_pos-val ((m <MotorGains-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xs_sdk-srv:ki_pos-val is deprecated.  Use interbotix_xs_sdk-srv:ki_pos instead.")
  (ki_pos m))

(cl:ensure-generic-function 'kd_pos-val :lambda-list '(m))
(cl:defmethod kd_pos-val ((m <MotorGains-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xs_sdk-srv:kd_pos-val is deprecated.  Use interbotix_xs_sdk-srv:kd_pos instead.")
  (kd_pos m))

(cl:ensure-generic-function 'k1-val :lambda-list '(m))
(cl:defmethod k1-val ((m <MotorGains-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xs_sdk-srv:k1-val is deprecated.  Use interbotix_xs_sdk-srv:k1 instead.")
  (k1 m))

(cl:ensure-generic-function 'k2-val :lambda-list '(m))
(cl:defmethod k2-val ((m <MotorGains-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xs_sdk-srv:k2-val is deprecated.  Use interbotix_xs_sdk-srv:k2 instead.")
  (k2 m))

(cl:ensure-generic-function 'kp_vel-val :lambda-list '(m))
(cl:defmethod kp_vel-val ((m <MotorGains-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xs_sdk-srv:kp_vel-val is deprecated.  Use interbotix_xs_sdk-srv:kp_vel instead.")
  (kp_vel m))

(cl:ensure-generic-function 'ki_vel-val :lambda-list '(m))
(cl:defmethod ki_vel-val ((m <MotorGains-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xs_sdk-srv:ki_vel-val is deprecated.  Use interbotix_xs_sdk-srv:ki_vel instead.")
  (ki_vel m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MotorGains-request>)))
  ...
  "interbotix_xs_sdk/MotorGainsRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MotorGains-request)))
  "Returns string type for a service object of type 'MotorGains-request"
  "interbotix_xs_sdk/MotorGainsRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <MotorGains-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorGains-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name interbotix_xs_sdk-srv:<MotorGains-response> is deprecated: use interbotix_xs_sdk-srv:MotorGains-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<MotorGains-response>)))
  ...
  "interbotix_xs_sdk/MotorGainsResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'MotorGains-response)))
  "Returns string type for a service object of type 'MotorGains-response"
  "interbotix_xs_sdk/MotorGainsResponse")
