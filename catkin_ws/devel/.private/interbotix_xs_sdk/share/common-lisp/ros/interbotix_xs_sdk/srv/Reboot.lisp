...
(cl:defmethod cl:initialize-instance :after ((m <Reboot-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Reboot-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name interbotix_xs_sdk-srv:<Reboot-request> is deprecated: use interbotix_xs_sdk-srv:Reboot-request instead.")))
...
(cl:defmethod enable-val ((m <Reboot-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xs_sdk-srv:enable-val is deprecated.  Use interbotix_xs_sdk-srv:enable instead.")
  (enable m))

(cl:ensure-generic-function 'smart_reboot-val :lambda-list '(m))
(cl:defmethod smart_reboot-val ((m <Reboot-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xs_sdk-srv:smart_reboot-val is deprecated.  Use interbotix_xs_sdk-srv:smart_reboot instead.")
  (smart_reboot m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Reboot-request>)))
  ...
  "interbotix_xs_sdk/RebootRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Reboot-request)))
  "Returns string type for a service object of type 'Reboot-request"
  "interbotix_xs_sdk/RebootRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <Reboot-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Reboot-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name interbotix_xs_sdk-srv:<Reboot-response> is deprecated: use interbotix_xs_sdk-srv:Reboot-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Reboot-response>)))
  ...
  "interbotix_xs_sdk/RebootResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Reboot-response)))
  "Returns string type for a service object of type 'Reboot-response"
  "interbotix_xs_sdk/RebootResponse")
