...
(cl:in-package interbotix_xsarm_joy-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <ArmJoy>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArmJoy)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name interbotix_xsarm_joy-msg:<ArmJoy> is deprecated: use interbotix_xsarm_joy-msg:ArmJoy instead.")))

(cl:ensure-generic-function 'ee_x_cmd-val :lambda-list '(m))
(cl:defmethod ee_x_cmd-val ((m <ArmJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xsarm_joy-msg:ee_x_cmd-val is deprecated.  Use interbotix_xsarm_joy-msg:ee_x_cmd instead.")
  (ee_x_cmd m))

(cl:ensure-generic-function 'ee_y_cmd-val :lambda-list '(m))
(cl:defmethod ee_y_cmd-val ((m <ArmJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xsarm_joy-msg:ee_y_cmd-val is deprecated.  Use interbotix_xsarm_joy-msg:ee_y_cmd instead.")
  (ee_y_cmd m))

(cl:ensure-generic-function 'ee_z_cmd-val :lambda-list '(m))
(cl:defmethod ee_z_cmd-val ((m <ArmJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xsarm_joy-msg:ee_z_cmd-val is deprecated.  Use interbotix_xsarm_joy-msg:ee_z_cmd instead.")
  (ee_z_cmd m))

(cl:ensure-generic-function 'ee_roll_cmd-val :lambda-list '(m))
(cl:defmethod ee_roll_cmd-val ((m <ArmJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xsarm_joy-msg:ee_roll_cmd-val is deprecated.  Use interbotix_xsarm_joy-msg:ee_roll_cmd instead.")
  (ee_roll_cmd m))

(cl:ensure-generic-function 'ee_pitch_cmd-val :lambda-list '(m))
(cl:defmethod ee_pitch_cmd-val ((m <ArmJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xsarm_joy-msg:ee_pitch_cmd-val is deprecated.  Use interbotix_xsarm_joy-msg:ee_pitch_cmd instead.")
  (ee_pitch_cmd m))

(cl:ensure-generic-function 'waist_cmd-val :lambda-list '(m))
(cl:defmethod waist_cmd-val ((m <ArmJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xsarm_joy-msg:waist_cmd-val is deprecated.  Use interbotix_xsarm_joy-msg:waist_cmd instead.")
  (waist_cmd m))

(cl:ensure-generic-function 'gripper_cmd-val :lambda-list '(m))
(cl:defmethod gripper_cmd-val ((m <ArmJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xsarm_joy-msg:gripper_cmd-val is deprecated.  Use interbotix_xsarm_joy-msg:gripper_cmd instead.")
  (gripper_cmd m))

(cl:ensure-generic-function 'pose_cmd-val :lambda-list '(m))
(cl:defmethod pose_cmd-val ((m <ArmJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xsarm_joy-msg:pose_cmd-val is deprecated.  Use interbotix_xsarm_joy-msg:pose_cmd instead.")
  (pose_cmd m))

(cl:ensure-generic-function 'speed_cmd-val :lambda-list '(m))
(cl:defmethod speed_cmd-val ((m <ArmJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xsarm_joy-msg:speed_cmd-val is deprecated.  Use interbotix_xsarm_joy-msg:speed_cmd instead.")
  (speed_cmd m))

(cl:ensure-generic-function 'speed_toggle_cmd-val :lambda-list '(m))
(cl:defmethod speed_toggle_cmd-val ((m <ArmJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xsarm_joy-msg:speed_toggle_cmd-val is deprecated.  Use interbotix_xsarm_joy-msg:speed_toggle_cmd instead.")
  (speed_toggle_cmd m))

(cl:ensure-generic-function 'gripper_pwm_cmd-val :lambda-list '(m))
(cl:defmethod gripper_pwm_cmd-val ((m <ArmJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xsarm_joy-msg:gripper_pwm_cmd-val is deprecated.  Use interbotix_xsarm_joy-msg:gripper_pwm_cmd instead.")
  (gripper_pwm_cmd m))

(cl:ensure-generic-function 'torque_cmd-val :lambda-list '(m))
(cl:defmethod torque_cmd-val ((m <ArmJoy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xsarm_joy-msg:torque_cmd-val is deprecated.  Use interbotix_xsarm_joy-msg:torque_cmd instead.")
  (torque_cmd m))
