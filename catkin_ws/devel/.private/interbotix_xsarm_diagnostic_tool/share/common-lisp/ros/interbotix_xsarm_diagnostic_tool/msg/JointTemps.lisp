...
(cl:in-package interbotix_xsarm_diagnostic_tool-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <JointTemps>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointTemps)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name interbotix_xsarm_diagnostic_tool-msg:<JointTemps> is deprecated: use interbotix_xsarm_diagnostic_tool-msg:JointTemps instead.")))

(cl:ensure-generic-function 'names-val :lambda-list '(m))
(cl:defmethod names-val ((m <JointTemps>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xsarm_diagnostic_tool-msg:names-val is deprecated.  Use interbotix_xsarm_diagnostic_tool-msg:names instead.")
  (names m))

(cl:ensure-generic-function 'temps-val :lambda-list '(m))
(cl:defmethod temps-val ((m <JointTemps>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xsarm_diagnostic_tool-msg:temps-val is deprecated.  Use interbotix_xsarm_diagnostic_tool-msg:temps instead.")
  (temps m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<JointTemps>)))
  ...
  "interbotix_xsarm_diagnostic_tool/JointTemps")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'JointTemps)))
  "Returns string type for a message object of type 'JointTemps"
  "interbotix_xsarm_diagnostic_tool/JointTemps")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<JointTemps>)))
  ...
  (cl:format cl:nil "# Holds the temperatures [C] for the specified joints~%~%string[] names~%int32[] temps~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'JointTemps)))
  "Returns full string definition for message of type 'JointTemps"
  (cl:format cl:nil "# Holds the temperatures [C] for the specified joints~%~%string[] names~%int32[] temps~%~%~%"))
