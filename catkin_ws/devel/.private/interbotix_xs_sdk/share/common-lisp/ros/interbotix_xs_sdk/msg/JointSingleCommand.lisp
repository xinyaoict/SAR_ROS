...
(cl:defmethod cl:initialize-instance :after ((m <JointSingleCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointSingleCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name interbotix_xs_sdk-msg:<JointSingleCommand> is deprecated: use interbotix_xs_sdk-msg:JointSingleCommand instead.")))
...
(cl:defmethod cmd-val ((m <JointSingleCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xs_sdk-msg:cmd-val is deprecated.  Use interbotix_xs_sdk-msg:cmd instead.")
  (cmd m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<JointSingleCommand>)))
  ...
  "interbotix_xs_sdk/JointSingleCommand")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'JointSingleCommand)))
  "Returns string type for a message object of type 'JointSingleCommand"
  "interbotix_xs_sdk/JointSingleCommand")
