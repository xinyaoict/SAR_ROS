...
(cl:defmethod cl:initialize-instance :after ((m <OperatingModes-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OperatingModes-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name interbotix_xs_sdk-srv:<OperatingModes-request> is deprecated: use interbotix_xs_sdk-srv:OperatingModes-request instead.")))
...
(cl:defmethod mode-val ((m <OperatingModes-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xs_sdk-srv:mode-val is deprecated.  Use interbotix_xs_sdk-srv:mode instead.")
  (mode m))

(cl:ensure-generic-function 'profile_type-val :lambda-list '(m))
(cl:defmethod profile_type-val ((m <OperatingModes-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xs_sdk-srv:profile_type-val is deprecated.  Use interbotix_xs_sdk-srv:profile_type instead.")
  (profile_type m))

(cl:ensure-generic-function 'profile_velocity-val :lambda-list '(m))
(cl:defmethod profile_velocity-val ((m <OperatingModes-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xs_sdk-srv:profile_velocity-val is deprecated.  Use interbotix_xs_sdk-srv:profile_velocity instead.")
  (profile_velocity m))
...
(cl:defmethod profile_acceleration-val ((m <OperatingModes-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xs_sdk-srv:profile_acceleration-val is deprecated.  Use interbotix_xs_sdk-srv:profile_acceleration instead.")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<OperatingModes-request>)))
  ...
  "interbotix_xs_sdk/OperatingModesRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'OperatingModes-request)))
  "Returns string type for a service object of type 'OperatingModes-request"
  "interbotix_xs_sdk/OperatingModesRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <OperatingModes-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'OperatingModes-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name interbotix_xs_sdk-srv:<OperatingModes-response> is deprecated: use interbotix_xs_sdk-srv:OperatingModes-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<OperatingModes-response>)))
  ...
  "interbotix_xs_sdk/OperatingModesResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'OperatingModes-response)))
  "Returns string type for a service object of type 'OperatingModes-response"
  "interbotix_xs_sdk/OperatingModesResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'OperatingModes)))
  ...
  "interbotix_xs_sdk/OperatingModes")