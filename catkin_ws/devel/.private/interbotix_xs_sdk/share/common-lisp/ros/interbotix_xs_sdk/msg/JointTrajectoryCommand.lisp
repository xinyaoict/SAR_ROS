...
(cl:in-package interbotix_xs_sdk-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <JointTrajectoryCommand>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'JointTrajectoryCommand)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name interbotix_xs_sdk-msg:<JointTrajectoryCommand> is deprecated: use interbotix_xs_sdk-msg:JointTrajectoryCommand instead.")))

(cl:ensure-generic-function 'cmd_type-val :lambda-list '(m))
(cl:defmethod cmd_type-val ((m <JointTrajectoryCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xs_sdk-msg:cmd_type-val is deprecated.  Use interbotix_xs_sdk-msg:cmd_type instead.")
  (cmd_type m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <JointTrajectoryCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xs_sdk-msg:name-val is deprecated.  Use interbotix_xs_sdk-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'traj-val :lambda-list '(m))
(cl:defmethod traj-val ((m <JointTrajectoryCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader interbotix_xs_sdk-msg:traj-val is deprecated.  Use interbotix_xs_sdk-msg:traj instead.")
  (traj m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<JointTrajectoryCommand>)))
  ...
  "interbotix_xs_sdk/JointTrajectoryCommand")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'JointTrajectoryCommand)))
  "Returns string type for a message object of type 'JointTrajectoryCommand"
  "interbotix_xs_sdk/JointTrajectoryCommand")
