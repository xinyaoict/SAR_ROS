...
"""autogenerated by genpy from interbotix_xs_sdk/RobotInfoRequest.msg. Do not edit."""
import codecs
import sys
...
class RobotInfoRequest(genpy.Message):
  ...
  _type = "interbotix_xs_sdk/RobotInfoRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from interbotix_xs_sdk/RobotInfoResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class RobotInfoResponse(genpy.Message):
  _md5sum = "aab05469cfeca32ce718e0ba473d9ba5"
  _type = "interbotix_xs_sdk/RobotInfoResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
"""
  __slots__ = ['mode','profile_type','joint_names','joint_ids','joint_lower_limits','joint_upper_limits','joint_velocity_limits','joint_sleep_positions','joint_state_indices','num_joints']
  _slot_types = ['string','string','string[]','int16[]','float32[]','float32[]','float32[]','float32[]','int16[]','int16']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       mode,profile_type,joint_names,joint_ids,joint_lower_limits,joint_upper_limits,joint_velocity_limits,joint_sleep_positions,joint_state_indices,num_joints
...
class RobotInfo(object):
  _type          = 'interbotix_xs_sdk/RobotInfo'
  _md5sum = '7a389566d99903aa71839d0052c9a055'
